...
import { BarChart3, Wallet, Target, MessageCircle, FileText } from "lucide-react";
...
export function CareHistoryTimeline({ notifications }: Props) {
            ...
            {sorted.map((n) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-start gap-3 py-3 px-2 -mx-2 rounded-lg hover:bg-muted/50 transition-colors group"
                >
                  <div
                    className={`shrink-0 h-8 w-8 rounded-lg flex items-center justify-center ${config.color}`}
                  >
